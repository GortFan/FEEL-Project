...
std::vector<std::vector<std::pair<int, int>>> makeAdjMatrix2D(
    int N, int M, int K,
...
vector<int> dialsDijkstra2D(const vector<vector<pair<int, int>>>& adj, const vector<int>& sources, int N, int M, int K) {
